...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-primary btn-lg"><a href="pembeku_input.php" style="color: white; text-decoration: none">+Data Bantuan Pembeku</a></button>
                                    ...
                                    <?php $no=1; $query = mysqli_query($kon, "SELECT * FROM transaksi INNER JOIN user ON transaksi.id = user.id WHERE konfirmasi = '' ORDER BY tgl DESC");
                                        while($data = mysqli_fetch_array($query)){ ?>
                                            <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="pembeku_detail.php?notransaksi=<?= $data['notransaksi'] ?>"><?= $data['nama'] ?></a> </td>
                                                    <td><?= $data['catatan'] ?></td>
                                                    <td>
