<?php require('atas.php'); $idjadwal = $_GET['idjadwal'];
  $query = mysqli_query($kon, "SELECT * FROM jadwal INNER JOIN user ON jadwal.id = user.id WHERE idjadwal = '$idjadwal'");
                    ...
                    <div class="panel-body">
                         <form role="form" action="" method="POST">
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input type="datetime" name="tgl" class="form-control" value="<?= $data['tgl'] ?>">
                            </div>
                            <div class="form-group">
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $ubah = mysqli_query($kon,"UPDATE jadwal SET id = '$id', tgl = '$tgl' WHERE idjadwal = '$idjadwal'");
