            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Meningkatkan Pendapatan serta Kesejahteraan para Petani Karet</p>
                ...
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Menjadi distributor bahan olahan karet (BOKAR) berkualitas tinggi</p>
                        <div class="shoes_icon">
                ...
                <div class="col-sm-4">
                    <div class="best_shoes">
                        <p class="best_text">Meningkatkan <i>Kualitas dan Kuantitas</i> dari BOKAR</p>
                        <div class="shoes_icon">
